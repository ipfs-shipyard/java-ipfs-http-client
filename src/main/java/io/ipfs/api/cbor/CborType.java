 ...
 *
 * <p>The major type is encoded in the upper three bits of each initial byte. The lower 5 bytes
...
public class CborType {
  ...
  /**
   * @return <code>true</code> if this type allows for an infinite-length payload, <code>false
   *     </code> if only definite-length payloads are allowed.
   */
  ...
  /**
   * Determines whether the major type of a given {@link CborType} equals the major type of this
   * {@link CborType}.
   *
   * @param other the {@link CborType} to compare against, cannot be <code>null</code>.
   * @return <code>true</code> if the given {@link CborType} is of the same major type as this
   *     {@link CborType}, <code>false</code> otherwise.
  ...
  /**
   * Determines whether the major type of a given byte value (representing an encoded {@link
   * CborType}) equals the major type of this {@link CborType}.
   *
   * @param encoded the encoded CBOR type to compare.
   * @return <code>true</code> if the given byte value represents the same major type as this {@link
   *     CborType}, <code>false</code> otherwise.
   */
