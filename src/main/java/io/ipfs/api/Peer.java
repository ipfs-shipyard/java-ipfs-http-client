...
public class Peer {
  ...
  public static Peer fromJSON(Object json) {
    ...
    return new Peer(
        new MultiAddress(val.apply("Addr")),
        peer,
        latency,
        val.apply("Muxer"),
        val.apply("Streams"));
  ...
  // See
  // https://github.com/Peergos/Peergos/blob/81064fdb2cdf6b6fe126cf6a20d4d40ecd148938/src/peergos/shared/io/ipfs/Cid.java#L148
