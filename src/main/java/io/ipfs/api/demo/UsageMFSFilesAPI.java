...
public class UsageMFSFilesAPI {
  ...
  private void run(IPFS ipfs) throws IOException {
    ...
    // To create a new directory nested under others that don't yet exist, you need to explicitly
    // set the value of parents to true
    ...
    // {Hash=QmV1a2QoUnB9fPzjZd1GunGR53isuhcWWNCS5Bg3mJyv8N, Size=0, CumulativeSize=57, Blocks=1,
    // Type=directory}
    ...
    NamedStreamable ipfsFile =
        new NamedStreamable.ByteArrayWrapper(ipfsFilename, "ipfs says hello".getBytes());
