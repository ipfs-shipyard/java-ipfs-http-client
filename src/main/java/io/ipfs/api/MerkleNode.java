...
public class MerkleNode {
  ...
  public static MerkleNode fromJSON(Object rawjson) {
    ...
    if (hash == null && json.containsKey("Cid")) hash = (String) (((Map) json.get("Cid")).get("/"));
    Optional<String> name =
        json.containsKey("Name") ? Optional.of((String) json.get("Name")) : Optional.empty();
    Object rawSize = json.get("Size");
    Optional<Integer> size =
        rawSize instanceof Integer ? Optional.of((Integer) rawSize) : Optional.empty();
    Optional<String> largeSize =
        rawSize instanceof String ? Optional.of((String) json.get("Size")) : Optional.empty();
    Optional<Integer> type =
        json.containsKey("Type") ? Optional.of((Integer) json.get("Type")) : Optional.empty();
    ...
    Optional<byte[]> data =
        json.containsKey("Data")
            ? Optional.of(((String) json.get("Data")).getBytes())
            : Optional.empty();
